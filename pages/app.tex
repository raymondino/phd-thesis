...
\begin{table}[!htbp]
    ...
    \begin{tabular}{|c||l|} \hline
         ...
         QueryParticipation & \makecell[l]{(\textit{used some} \textbf{QueryEngine}) \textit{and} \\ (\textit{used some} \textbf{StreamingDataGraph}) \textit{and} \\(\textit{used some} \textbf{BackgroundOntology}) \textit{and} \\(\textit{generated some} \textbf{QueryResult})} \\ \hline 
...
\begin{lstlisting}[caption={Example Streaming Data},basicstyle=\small,frame=single]
