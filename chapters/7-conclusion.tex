...
%dlm  what do you mean it is expendable thanks to the si ontology and that helps understand SI with grounding instances?   Do you mean it is extensible?  Yes it is but i am not sure how the grounding instances comes into that
%rui - todo - update the next sentence - probably make it two - it is extensible but what are trying to say on the instance stuff?
